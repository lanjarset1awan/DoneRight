...
export default function Dashboard({ token, user, onLogout, onNavigateReport, onNavigateTrash, onNavigateProfile }) {
  // State
  ...
  return (
    <div>
      ...
      <nav className="dashboard-navbar">
        ...
        <div className="btn-group-row" style={{ alignItems: "center" }}>
          {/* NOTIFICATION BELL */}
